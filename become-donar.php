...
$barcode = new \Com\Tecnick\Barcode\Barcode();
    ...
    $bobj = $barcode->getBarcodeObj('QRCODE,H', $_POST["mobileno"], - 16, - 16, 'black', array(
        - 2,
        - 2,
        - 2,
        - 2
	...
	$fileName = $targetPath . $timestamp .".png"; 
        $image = $fileName; 
        $imgContent = addslashes(file_get_contents($image)); 
		$status=1;
		$insert = $dbh->query("INSERT into tblblooddonars (FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status,Image) VALUES ('$fullname','$mobile','$email','$age','$gender','$blodgroup','$address','$message','$status','$imgContent')"); 
